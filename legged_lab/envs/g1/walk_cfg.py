...
#
# G1 23DoF Walk task configuration.
...
class GaitCfg:
    ...
    gait_phase_offset_l: float = 0.4
    gait_phase_offset_r: float = 0.9
...
class G1WalkFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/g1/datasets/motion_visualization/walk.txt"]
    device: str = "cuda:0"
...
class G1WalkAgentCfg(RslRlOnPolicyRunnerCfg):
    ...
    # AMP parameters
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/g1/datasets/motion_amp_expert/walk.txt"]
